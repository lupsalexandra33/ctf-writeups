...
1. `README.md` - The step-by-step write-up explaining the vulnerability and the logic behind the solution.
2. `solve.py` - The functional code used to solve the challenge or retrieve the flag.
3. *Files* - (Optional) Relevant binaries, captures, or source code provided during the CTF.
